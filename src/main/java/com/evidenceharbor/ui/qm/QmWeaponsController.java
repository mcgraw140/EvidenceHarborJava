...
public class QmWeaponsController implements Initializable {

    @FXML private TextField tfSearch;
    @FXML private ComboBox<String> cbTypeFilter;
    @FXML private ComboBox<String> cbCaliber;
    @FXML private TableView<?> weaponsTable;
    ...
    @FXML private void onAddWeapon() {
        System.out.println("Add Weapon clicked");
    }
